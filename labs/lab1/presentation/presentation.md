...
- 2024-2024/Информационная безопасность/infosec
...
- Были приобретены практические навыки оформления отчётов с помощью легковесного языка разметки Markdown.
...
[3] Документация по Markdown: https://learn.microso